...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(QIcon(":/icons/1home"), tr("&Overview"), this);
    overviewAction->setToolTip(tr("Show general overview of wallet"));
    overviewAction->setCheckable(true);
    overviewAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
    tabGroup->addAction(overviewAction);

    walletPinkAction = new QAction(QIcon(":/icons/1cloud"), tr("&wallet.PINK"), this);
    walletPinkAction->setToolTip(tr("Connect to wallet.PINK"));
    ...
    sendCoinsAction = new QAction(QIcon(":/icons/1send"), tr("&Send coins"), this);
    sendCoinsAction->setToolTip(tr("Send coins to a pinkcoin address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/1recieve"), tr("&Receive coins"), this);
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving payments"));
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(receiveCoinsAction);

    historyAction = new QAction(QIcon(":/icons/1transactions"), tr("&Transactions"), this);
    historyAction->setToolTip(tr("Browse transaction history"));
    historyAction->setCheckable(true);
    historyAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_4));
    tabGroup->addAction(historyAction);

    explorerPageAction = new QAction(QIcon(":/icons/1search"), tr("Block E&xplorer"), this);
    ...
    addressBookAction = new QAction(QIcon(":/icons/1addressbook"), tr("&Address Book"), this);
